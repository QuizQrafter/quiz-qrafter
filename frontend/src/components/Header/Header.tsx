    ...
    return (
        <header className={styles.header}>
            <h1 className={styles.logo}>
                <Link to="/" className={styles.logoLink}>Quiz Qrafter</Link>
            </h1>
                ...
                <div className={styles.mobileMenu}>
                    <div className={styles.mobileMenuHeader}>
                        <h1 className={styles.logoMobile}>
                            <Link to="/" className={styles.logoLink} onClick={handleLogoClick}>Quiz Qrafter</Link>
                        </h1>
                        <button className={styles.closeButton} onClick={toggleMobileMenu}>×</button>
                    </div>
                    <nav className={styles.mobileNav}>
                        <Link to="/" className={styles.mobileMenuItem} onClick={toggleMobileMenu}>Home</Link>
                        <Link to="/login" className={styles.mobileMenuItem} onClick={toggleMobileMenu}>Log in</Link>
                        <Link to="/signup" className={styles.mobileMenuItem} onClick={toggleMobileMenu}>Sign up</Link>
